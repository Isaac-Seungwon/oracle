...
INSERT INTO HR.TBLORIGIN (ORIGINSEQ,ORIGINNAME,ORIGINFORM,ORIGINALAUTHOR) VALUES
	 ('1','신비한 동물들과 덤블도어의 비밀','도서','J K 롤링, 스티브 클로브스'),
	 ('2','경관의 피(블랙 앤 화이트 60)','도서','사사키 조'),
	 ('3','오늘 밤, 세계에서 이 사랑이 사라진다 해도','도서','이치조 미사키'),
	 ('4','뜨거운 피','도서','김언수');

	
-- TBLOST
INSERT INTO HR.TBLOST (OSTSEQ,OSTNAME) VALUES
	 ('1','탑건 : 매버릭 (Top Gun: Maverick) (영화 OST)'),
	 ('2','Avatar: The Way of Water (Original Motion Picture Soundtrack)'),
	 ('3','공조2: 인터내셔날'),
	 ('4','Doctor Strange in the Multiverse of Madness (Original Motion Picture Soundtrack)'),
	 ('5','올빼미 OST'),
	 ('6','Thor: Love and Thunder (Original Motion Picture Soundtrack)'),
	 ('7','Minions: The Rise Of Gru (Original Motion Picture Soundtrack)'),
	 ('8','Black Panther: Wakanda Forever (Original Score)'),
	 ('9','Spider-Man: No Way Home (Original Motion Picture Soundtrack) 영화 <스파이더맨: 노 웨이 홈> OST'),
	 ('10','영웅');
INSERT INTO HR.TBLOST (OSTSEQ,OSTNAME) VALUES
	 ('11','브로커'),
	 ('12','Fantastic Beasts: The Secrets of Dumbledore (Original Motion Picture Soundtrack)'),
	 ('13','인생은 아름다워 OST'),
	 ('14','The Batman (Original Motion Picture Soundtrack)'),
	 ('15','데시벨 OST'),
	 ('16','항해 (데시벨 OST X 차은우)'),
	 ('17','정직한 후보 2 OST'),
	 ('18','Sing 2 (Original Motion Picture Soundtrack)'),
	 ('19','Black Adam (Original Motion Picture Soundtrack)'),
	 ('20','킹메이커 OST');
INSERT INTO HR.TBLOST (OSTSEQ,OSTNAME) VALUES
	 ('21','Uncharted (Original Motion Picture Soundtrack)'),
	 ('22','오늘 밤, 세계에서 이 사랑이 사라진다 해도 (今夜、世界からこの恋が消えても) Original Soundtrack'),
	 ('23','이상한 나라의 수학자'),
	 ('24','고백 (영화 ''동감'' X 츄 (이달의 소녀))'),
	 ('25','습관 (Bye Bye) (영화 ''동감'' X meenoi (미노이))'),
	 ('26','개똥벌레 (영화 ''동감'' X 이무진)'),
	 ('27','너에게로 가는 길 (영화 ''동감'' X 엔플라잉 (N.Flying))'),
	 ('28','늘 지금처럼 (영화 ''동감'' X VIVIZ (비비지))'),
	 ('29','편지 (영화 ''동감'' X 윤하 (YOUNHA))'),
	 ('30','너를 위해 (영화 ''동감'' X 황치열)');
INSERT INTO HR.TBLOST (OSTSEQ,OSTNAME) VALUES
	 ('31','Morbius (Original Motion Picture Soundtrack)'),
	 ('32','늑대사냥 OST'),
	 ('33','뽀로로 극장판 드래곤캐슬 대모험'' OST'),
	 ('34','특송 OST'),
	 ('35','리멤버 OST'),
	 ('36','The King''s Man (Original Motion Picture Soundtrack)'),
	 ('37','뜨거운 피 OST');
...
INSERT INTO HR.TBLSERIES (SERIESSEQ,SERIESENAME,SERIESRELEASE,DIRECTOR,ACTOR,SEQ) VALUES
	 ('1','범죄도시',TIMESTAMP'2017-10-03 00:00:00.0','강윤성','마동석, 윤계상, 조재윤, 최귀화, 임형준, 진선규, 홍기준, 허동원, 하준','1'),
	 ('2','범죄도시3',TIMESTAMP'2023-05-31 00:00:00.0','이상용','마동석, 이준혁, 아오키 무네타카, 이범수, 김민재, 이지훈, 김도건, 고규필, 전석호','1'),
	 ('3','범죄도시4',NULL,'허명행','마동석, 김무열, 이동휘, 박지환, 이범수, 김민재, 이지훈, 이주빈, 김도건','1'),
